...
import GastosPoliza from './GastosPolizas';
...
const RegistrarPoliza = () => {
    ...
    const onFinish = async (values) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8000/PolizasEspeciales/RegistrarPoliza', formData, {
                headers: {
                    'Authorization': token,
    ...
    return (
        <div style={{ backgroundColor: '#2e1437', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
            {currentStep === 1 && (
                <div>
                    <Header style={{ backgroundColor: 'black', textAlign: 'center', paddingBottom: '2rem', borderRadius: '10px', marginBottom: '1rem', width: '100%' }}>
                        <h1 className="title">Datos generales de la poliza</h1>
                    </Header>
                    <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', marginTop: '3rem', marginBottom: '2rem' }}>
                        <img src="https://cdn-icons-png.flaticon.com/512/4599/4599122.png" style={{ maxHeight: '200px' }} alt="Imagen de registro de siniestro" />
                    </div>
            ...
            {currentStep === 2 && (
                <div>
                    <GastosPoliza Id_SiniestroApasar ={idSiniestro}/>
                </div>
            )}
            <br />
            <br />
