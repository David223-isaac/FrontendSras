...
const AcuerdosConTercerosPolizas = ({ Id_SiniestroApasar }) => {
    ...
    const onFinish = async (values) => {
        ...
        try {
           ...
           if (resultadoOptions.includes(Resultado)) {
            ...
            let endpoint = '';
            if (resultadoOptions.includes(Resultado)) {
                endpoint = 'http://localhost:8000/ResultadosTercerosInvolucradosPolizas/RegistrarResultadosConTercerosInvolucrados';
            } else if (resultadoOptionsExtends.includes(Resultado)) {
                endpoint = 'http://localhost:8000/ResultadosTercerosInvolucradosExtendidosPolizas/RegistrarResultadosConTercerosInvolucrados';
            }
    ...
    return (
        <div style={{borderRadius: '8px', textAlign: 'center', width: '102%'}}>
            <h1 className="title">Acuerdos con Terceros involucrados en poliza</h1>
            <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', marginTop: '2rem', marginBottom: '2rem' }}>
                <img src="https://cdn-icons-png.flaticon.com/512/5663/5663344.png" style={{ maxHeight: '150px' }} alt="Gastos.jpg" />
            </div>
                                  ...
                                  <Col xs={24} md={12}>
                                      <Form.Item
                                          ...
                                          rules={[{ required: true, message: 'Por favor seleccione una opción' },
                                            ...
                                            {max: 5, message: "El monto no puede ser tan alto"}
                                          ]}
                                      >
                                          <Input />
                                      </Form.Item>
...
export default AcuerdosConTercerosPolizas;
